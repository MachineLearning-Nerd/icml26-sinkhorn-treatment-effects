...
---
<!-- trackio-cell
{"type": "code", "id": "cell_cd2affb1e2f2", "created_at": "2026-07-22T15:51:44+00:00", "title": "Verify C1-C6", "command": ["python", "repro/src/verify.py"], "exit_code": 0, "duration_s": 22.893}
-->
````bash
...
````output
C1 STE definition:        True
C4 degenerate null:       True
C5 normal under alt:      True
C6 type I error:          True  (null rej=0.025)
C2/C3 differentiability:  True  (via consequence)

VERIFIED 5/5 checked claim-groups (C1, C2/C3, C4, C5, C6)
